...
export default function SocialLogin() {
  ...
  return (
    <>
      <Button
        variant='secondary'
        className='bg-[#DB4437] text-white hover:bg-red-500 dark:hover:bg-[#da5447]'
      ...
      <Button
        variant='secondary'
        className='bg-black text-white hover:bg-gray-800 dark:hover:bg-neutral-900'
        onClick={() => handleSocialLogin('github')}
      >
        {status.loading && status.provider === 'gitgub' ? (
          <Loader2 className='mr-2 h-4 w-4 animate-spin text-white' />
        ) : (
          <svg
            role='img'
